...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($data['no_ordre']) || empty($data['nom']) || empty($data['prenom']) || empty($data['no_fiche']) || 
        ...
        // Check if student with same no_ordre already exists (excluding current student)
...
<head>
    ...
    <title>Modifier un Étudiant - Système de Gestion</title>
    ...
    <div class="container">
        <header>
            ...
            <div class="navigation">
                ...
                <a href="view_student.php?id=<?php echo $id; ?>" class="btn">Voir l'étudiant</a>
            </div>
        </header>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="no_ordre" name="no_ordre" value="<?php echo htmlspecialchars($student['no_ordre']); ?>" required>
                            </div>
                            
                            <div class="form-group">
                                <label for="no_fiche">No de fiche *</label>
                                <input type="text" id="no_fiche" name="no_fiche" value="<?php echo htmlspecialchars($student['no_fiche']); ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="année" name="année" value="<?php echo htmlspecialchars($student['année']); ?>" min="2000" max="2100" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="droit_civil_s1" name="droit_civil_s1" value="<?php echo htmlspecialchars($student['droit_civil_s1']); ?>" min="0" max="100">
                            </div>
                            
                            <div class="form-group">
                                <label for="procedure_penale_s1">Procédure Pénale (Session 1)</label>
                                <input type="number" id="procedure_penale_s1" name="procedure_penale_s1" value="<?php echo htmlspecialchars($student['procedure_penale_s1']); ?>" min="0" max="100">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="contentieux_administratif_s1" name="contentieux_administratif_s1" value="<?php echo htmlspecialchars($student['contentieux_administratif_s1']); ?>" min="0" max="100">
                            </div>
                            
                            <div class="form-group">
                                <label for="securites_sociales_s1">Sécurités Sociales (Session 1)</label>
                                <input type="number" id="securites_sociales_s1" name="securites_sociales_s1" value="<?php echo htmlspecialchars($student['securites_sociales_s1']); ?>" min="0" max="100">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="voies_execution_s1" name="voies_execution_s1" value="<?php echo htmlspecialchars($student['voies_execution_s1']); ?>" min="0" max="100">
                            </div>
                            
                            <div class="form-group">
                                <label for="procedure_commerciale_s1">Procédure Commerciale (Session 1)</label>
                                <input type="number" id="procedure_commerciale_s1" name="procedure_commerciale_s1" value="<?php echo htmlspecialchars($student['procedure_commerciale_s1']); ?>" min="0" max="100">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="droits_humains_s1" name="droits_humains_s1" value="<?php echo htmlspecialchars($student['droits_humains_s1']); ?>" min="0" max="100">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="droit_civil_s2" name="droit_civil_s2" value="<?php echo htmlspecialchars($student['droit_civil_s2']); ?>" min="0" max="100">
                            </div>
                            
                            <div class="form-group">
                                <label for="procedure_penale_s2">Procédure Pénale (Session 2)</label>
                                <input type="number" id="procedure_penale_s2" name="procedure_penale_s2" value="<?php echo htmlspecialchars($student['procedure_penale_s2']); ?>" min="0" max="100">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="contentieux_administratif_s2" name="contentieux_administratif_s2" value="<?php echo htmlspecialchars($student['contentieux_administratif_s2']); ?>" min="0" max="100">
                            </div>
                            
                            <div class="form-group">
                                <label for="securites_sociales_s2">Sécurités Sociales (Session 2)</label>
                                <input type="number" id="securites_sociales_s2" name="securites_sociales_s2" value="<?php echo htmlspecialchars($student['securites_sociales_s2']); ?>" min="0" max="100">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="voies_execution_s2" name="voies_execution_s2" value="<?php echo htmlspecialchars($student['voies_execution_s2']); ?>" min="0" max="100">
                            </div>
                            
                            <div class="form-group">
                                <label for="procedure_commerciale_s2">Procédure Commerciale (Session 2)</label>
                                <input type="number" id="procedure_commerciale_s2" name="procedure_commerciale_s2" value="<?php echo htmlspecialchars($student['procedure_commerciale_s2']); ?>" min="0" max="100">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="droits_humains_s2" name="droits_humains_s2" value="<?php echo htmlspecialchars($student['droits_humains_s2']); ?>" min="0" max="100">
                            </div>
                        </div>
                    </div>
